...
HD_PWD='C:/Users/Jake/Engineering/ZYNQ/Custom-PL/Custom-PL.runs/design_1_JG_ZYNQ_RGB_CORE_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_JG_ZYNQ_RGB_CORE_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_JG_ZYNQ_RGB_CORE_0_0.tcl
